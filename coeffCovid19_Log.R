...
#nx=147 #dimensão para métodos dos mínimos quadrados
...
par (new = TRUE); 
    ...
    plot( coeff_ll[,1]/100, coeff_ll[,2], 
         ...
         cex.main = ftsize , cex.lab = ftsizelb, cex.axis = ftsizeax
         );
    grid(lty=3, lwd=2);
      ...
      par( new = TRUE);
          ...
          plot( q,predicted.intervals[,1],ylab="", xlab="",
             xlim = xlimitec, ylim = c(0,1), cex.main = ftsize , cex.lab = ftsizelb, cex.axis = ftsizeax, col = color_l[1], type = "l", lty=1, lwd=2 ); 
...
par (new = TRUE); 
    ...
    plot( coeff_ll[,1]/100, coeff_ll[,3], 
      ...
      plot( q,predicted.intervals[,1],ylab="", xlab="",
             xlim = xlimitec, ylim = ylimitec, cex.main = ftsize , cex.lab = ftsizelb, cex.axis = ftsizeax, col = color_l[1], type = "l", lty=1, lwd=2 ); 
