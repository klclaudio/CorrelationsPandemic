...
png( str_c( homedir, homepval, "PvaluesCovidABO", type_stat, l_count, "_", i_days, ".png"), width = 700, height = 700 )
   ...
   plot( xp, correlacoest[, "O+"], main = "ABO System and Rh+ (a)", ylab = "Pvalues", xlab = "Days since five deaths (x 10²)",
  ...
  #pch = c(10, 12, 9, 8, 1, 0, 5, 4))
   ...
   plot( xp, correlacoest[, "O-"], main = "ABO System and Rh- (b)", ylab = "Pvalues", xlab = "Days since five deaths (x 10²)",
...
#                                      )
   ...
   plot( xp, correlacoest_abo_rh[,"Rh+"],  main = "Rhesus (Rh) System (d)", ylab = "Pvalues", xlab = "Days since five deaths (x 10²)",
