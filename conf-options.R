...
#owid_file     <- "owid-covid-data02022024.csv" # Saved data.
...
N_i           <- 190 #1080 # Numbers week/days considered since 5th death - loop i,  min four countries for analysi.s
nx            <- 180 #1050 # Numbers week/days considered for fitting.
ndata         <- 4   #  Sets of countries analyzed.
interval_days <- 7   #1   # Data interval days from owid data, 19012024 uses 1, data02022024 uses 7.
