...
#minimos quadrados entre covid e tipos sanguíneos  
...
#minimos quaadrados entre covid e tipos sanguíneos            
...
#            lm10_aux2 <- lm( btcovid2_frame[,10]~ btcovid2_frame[,10]);             #Gerando warning
            
#coefficients angulares
...
#coefficients lineares (intercept)
...
# Coeficiente de determinação
    ...
    coeff_ll = rbind( coeff_ll, c(i, summary(lm10_bt)$coef[[2]], summary(lm10_bt)$coef[[1]]) ); # covid
    coeff_aux = rbind( coeff_aux, c(ll, i, summary(lm10_bt)$coef[[2]], summary(lm10_bt)$coef[[1]]) ) # todos
